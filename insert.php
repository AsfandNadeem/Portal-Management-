...
<div class="dropdown">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
    <li role="presentation"><a role="menuitem" href="insertcat.php">Catgeory</a></li>
    <li role="presentation"><a role="menuitem" href="insertsubcat.php">SubCategory</a></li>
    <li role="presentation"><a role="menuitem" href="#">Items</a></li>
